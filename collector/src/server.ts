...
// (no aliases — the old paths 404). The Worker twin shares one document; a parity test binds them.
//
...
// The committed OpenAPI document, served verbatim at GET /openapi.json (C9/C13 clause 6). Both
 ...
 * the dispatcher (to match), the conformance suite (to enumerate, C13 clause 2), and the
