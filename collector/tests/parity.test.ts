// Route-parity between the collector and its Cloudflare Worker twin (API-M3 criterion 4).
//
...
// makes the sets differ and this test fails. That is the property criterion 4 demands ("adding a
// route to one only makes the test fail"), and it does not exist in the repo before API-M3.
