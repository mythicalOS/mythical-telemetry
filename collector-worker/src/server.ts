...
// and /healthz paths are not served (no aliases — they 404). This Worker shares ONE document with the collector twin.
//
...
// The committed OpenAPI document, served verbatim at GET /openapi.json. The
